                ...
                <ScrollView>
                    ...
                    <View style={{width: WIDTH, height: HEIGHT, backgroundColor: 'white', alignItems: 'center', marginTop:40, flex: 1, borderRadius: 35,}}>
                        <View style={{width: 354, height: 470, backgroundColor: '#018EF7', marginTop: 20, borderRadius: 20, alignItems: 'center', }}>
                            ...
                            <View style={{marginTop:30, marginRight: 180}}>
                                <Text style={{fontWeight: 'bold', fontSize: 13.28, color: 'white'}}>Top Up Amoount</Text>
                                <TextInput style={[styles.searchbox]}></TextInput>
                            </View>
                            <View style={{marginTop:60, marginRight: 180}}>
                                <Text style={{fontWeight: 'bold', fontSize: 13.28, color: 'white'}}>Top Up Methode</Text>
                                <View style={[styles.searchbox1]}>
                                    ...
                                    >
                                        <Picker.Item label="Bank Transfer (Virtual Account)" value="VA"></Picker.Item>
                                        <Picker.Item label="Electronic Money (OVO, Dana, Etc)" value="EM"></Picker.Item>
                                    </Picker>
                                </View>
                            </View>
                            <View>
                                <View style={{backgroundColor: 'white', width: 100, height: 39, borderRadius: 5, marginTop:70, justifyContent: 'center', alignItems: 'center'}}>
                                    <Text style={{color: '#018EF7', fontWeight: 'bold', fontSize:16}} onPress = {() => this.props.navigation.navigate ('Method')}>Next</Text>
                                </View>
                            </View>
                        </View>
                    </View>
