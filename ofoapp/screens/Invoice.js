                    ...
                    <View style={{width: WIDTH, height: HEIGHT, backgroundColor: 'white', alignItems: 'center', marginTop:40, flex: 1, borderRadius: 35,}}>
                        <View style={{width: 354, height: 470, backgroundColor: '#018EF7', marginTop: 20, borderRadius: 20, alignItems: 'center', }}>
                            ...
                            <View style={{marginTop:20, marginRight: 0}}>
                                ...
                                <View style={{backgroundColor: 'white', width: 276, height: 130, borderRadius: 4, alignItems: 'center'}}>
                                    <Text style={{fontWeight: 'bold', marginTop:10}}>BCA Virtual ACCOUNT</Text>
                                    <Text style={{fontWeight: 'bold', marginTop:5, fontSize:22, color:'#018EF7'}}>1234 56 7890 1234</Text>
                                    <Text style={{fontWeight: 'bold'}}>Enter VA Code 3450</Text>
                                    <Text style={{marginTop:5, fontSize: 10}}>Make Sure name is Pipit</Text>
                                    <Text style={{fontSize: 10}}>The Balance will Automatic Fill if The Transferr success</Text>
                                </View>
                            </View>
                            <View>
                                <View style={{backgroundColor: 'white', width: 100, height: 39, borderRadius: 5, marginTop:20, justifyContent: 'center', alignItems: 'center'}}>
                                    <Text style={{color: '#018EF7', fontWeight: 'bold', fontSize:16}} onPress = {() => this.props.navigation.navigate ('Home')}>Finish</Text>
                                </View>
                            </View>
                        </View>
                    </View>
