...
export default class Nearme2 extends React.Component {
    render(){
        return(
            <SafeAreaView style={{flex: 1, backgroundColor: '#018EF7',}}>
                <ScrollView>
                    ...
                    <View style={{width: WIDTH, height: HEIGHT, backgroundColor: 'white', alignItems: 'center', marginTop:20, top:20, flex: 1, borderRadius: 35,}}>
                            ...
                            <View style={{flexDirection:'row',borderColor: 'black', justifyContent: 'center', width: 374, height: 132}}>
                                ...
                                <View style={{flex:1, justifyContent: 'center', alignItems:'center', marginLeft:150,}}>
                                    ...
                                    <View style={{flexDirection:'row'}}>
                                        <View style={{backgroundColor:"#018EF7", width: 21, height:21, borderRadius: 100/2, alignItems:'center', justifyContent: 'center' }}>
                                            <Text style={{color: 'white', fontWeight: 'bold', fontSize: 12}}>-</Text>
                                        </View>
                                        <View style={{ width: 49, height:21, borderRadius: 10, alignItems:'center', justifyContent: 'center' }}>
                                            <Text style={{color: 'black', fontWeight: 'bold', fontSize: 12}}>2</Text>
                                        </View>
                                        <View style={{backgroundColor:"#018EF7", width: 21, height:21, borderRadius: 100/2, alignItems:'center', justifyContent: 'center' }}>
                                            <Text style={{color: 'white', fontWeight: 'bold', fontSize: 12}}>+</Text>
                                        </View>
                            ...
                            <View style={{flexDirection:'row',borderColor: 'black', justifyContent: 'center', width: 374, height: 132}}>
                                ...
                                <View style={{flex:1, justifyContent: 'center', alignItems:'center', marginLeft:150}}>
                                    ...
                                    <View style={{flexDirection:'row'}}>
                                        ...
                                        <View style={{ width: 49, height:21, borderRadius: 10, alignItems:'center', justifyContent: 'center' }}>
                                            <Text style={{color: 'black', fontWeight: 'bold', fontSize: 12}}>1</Text>
                                        </View>
                                        <View style={{backgroundColor:"#018EF7", width: 21, height:21, borderRadius: 100/2, alignItems:'center', justifyContent: 'center' }}>
                                            <Text style={{color: 'white', fontWeight: 'bold', fontSize: 12}}>+</Text>
                                        </View>
                        ...
                        <View style={{justifyContent: 'center', alignItems:'center', backgroundColor:"#018EF7", width: 300, height:50, borderRadius: 10, marginTop:300 }}>
                            <Text style={{color: 'white', fontWeight: 'bold', fontSize: 22}} onPress = {() => this.props.navigation.navigate ('Order')}>45.000</Text>
                            <Text style={{color: 'white', fontWeight: 'bold', fontSize: 15, marginBottom: 5}} onPress = {() => this.props.navigation.navigate ('Order')}>3 Item</Text>
                        </View>
                    </View>
                </ScrollView>
            </SafeAreaView>
